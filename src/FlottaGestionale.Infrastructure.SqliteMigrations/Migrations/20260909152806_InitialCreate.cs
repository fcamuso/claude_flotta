        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroPatente = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    CategoriaPatente = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    DataScadenzaPatente = table.Column<DateOnly>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    RagioneSociale = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    PartitaIva = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Indirizzo = table.Column<string>(type: "TEXT", maxLength: 250, nullable: true),
                    Telefono = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    Email = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    Attivo = table.Column<bool>(type: "INTEGER", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Denominazione = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Indirizzo = table.Column<string>(type: "TEXT", maxLength: 250, nullable: false),
                    ...
                    Provincia = table.Column<string>(type: "TEXT", maxLength: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Targa = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    Marca = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Modello = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Anno = table.Column<int>(type: "INTEGER", nullable: true),
                    ChilometraggioAttuale = table.Column<int>(type: "INTEGER", nullable: false),
                    IntervalloManutenzioneKm = table.Column<int>(type: "INTEGER", nullable: false),
                    ChilometraggioUltimaManutenzione = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    AutistaId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoEvento = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Data = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ChilometraggioEvento = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AutistaId = table.Column<int>(type: "INTEGER", nullable: false),
                    MezzoId = table.Column<int>(type: "INTEGER", nullable: false),
                    ClienteId = table.Column<int>(type: "INTEGER", nullable: false),
                    DataPianificata = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DataInizio = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DataFine = table.Column<DateTime>(type: "TEXT", nullable: true),
                    KmPercorsi = table.Column<int>(type: "INTEGER", nullable: true),
                    Stato = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Note = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TrattaId = table.Column<int>(type: "INTEGER", nullable: false),
                    DestinazioneId = table.Column<int>(type: "INTEGER", nullable: false),
                    Ordine = table.Column<int>(type: "INTEGER", nullable: false),
                    Stato = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    DataOraCompletamento = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Note = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
